...
# Comment out CHANNEL_LAYERS above and use this instead:
# CHANNEL_LAYERS = {
...
# Crowd thresholds
CROWD_LOW_THRESHOLD = 0.3    # 30% of capacity
CROWD_HIGH_THRESHOLD = 0.7   # 70% of capacity
CROWD_ALERT_THRESHOLD = 0.8  # 80% triggers alert
