...
2️⃣ Start Redis (for WebSocket channel layer)
...
Uses OpenCV HOG descriptor. Fast, no GPU needed.

▸ YOLODetector

Uses YOLOv8 (ultralytics). More accurate.
...
3️⃣ Detection Worker Architecture
